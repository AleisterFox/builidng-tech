...
<head>
  ...
  <meta property="og:title" content="Building-Tech" />
  ...
  <meta property="og:site_name" content="Building-Tech" />
      ...
      <div class="container">
        <div class="text fadeIn wow">
          ...
          <ul>
            ...
            <li>Renders con calidad de estudio</li>
            <li>Recorridos virtuales</li>
            <li>Obra civil en todas las etapas de obra desde terracerías, cimentación obra negra, obra gris y acabados finos.</li>
            <li>Calculo, revisión y firma de proyectos estructurales.</li>
            <li>Remodelación de espacios.</li>
            <li>Demoliciones</li>
            <li>Supervisión y administración de obra</li>
          </ul>
        </div>
        <div class="images">
          <div class="parent">
      ...
      <div class="container">
        ...
        <div class="text fadeIn wow">
          ...
          <ul>
            ...
            <li>Diseño e instalación de UPS, transfer y plantas de emergencia para instalaciones criticas</li>
            <li>Instalaciones de audio y video profesional</li>
            <li>Diseño e Instalación de redes de cableado estructurado de voz y datos con cableado certificado de extremo a extremo apegados a las normas ANSI/TIA/EIA</li>
            <li>Diseño e Instalación de sistemas de circuitos cerrados de televisión (CCTV)</li>
            <li>Instalaciones de sistemas de aire acondicionado y proyectos de inyección y extracción de aire basados en la norma de ASHRAE</li>
            <li>Diseño e instalación de equipos contra incendio PCI</li>
          </ul>
        </div>
      </div>
    </section>
